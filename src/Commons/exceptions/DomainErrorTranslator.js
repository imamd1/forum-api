...
DomainErrorTranslator._directories = {
  ...
  'NEW_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat thread baru, input tidak lengkap'),
  ...
  'NEW_COMMENT.NOT_AVAILABLE_THREAD': new NotFoundError('thread tidak ditemukan'),
  'NEW_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat comment baru, input tidak lengkap'),
